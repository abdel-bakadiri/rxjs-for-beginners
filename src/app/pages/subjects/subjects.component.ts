...
setTimeout(() => subject$.subscribe(rxObserver('subject$ 2')), 500);
setTimeout(() => subject$.next(2), 1000);
subject$.subscribe(rxObserver('subject$'));`;
...
setTimeout(() => behaviorSubject$.subscribe(rxObserver('behaviorSubject$ 2')), 500);
setTimeout(() => behaviorSubject$.next(2), 1000);
behaviorSubject$.subscribe(rxObserver('behaviorSubject$'));
...
setTimeout(() => replaySubject$.subscribe(rxObserver('replaySubject$ 2')), 500);
setTimeout(() => replaySubject$.next(2), 1000);
replaySubject$.subscribe(rxObserver('replaySubject$'));`;
